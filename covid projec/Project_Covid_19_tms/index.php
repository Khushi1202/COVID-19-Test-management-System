...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Covid-19 Test Management</title>
   ...
   <body>
                  ...
                  <div class="menu_text">
                     <ul>
                        <div class="togle_">
                           <div class="menu_main">
                              <ul>
                                 <li><a href="loginsession.php">Login</a></li>
                        ...
                        <div id="myNav" class="overlay">
                           ...
                           <div class="overlay-content">
                              <a href="index.php">Home</a>
								...
								<a href="Testbooking.php">Book Test</a>
               ...
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <div class="row">
                        <div class="col-md-6">
                           <div class="container">
                              <h1 class="banner_taital">Book Your Test Online</h1>
                              <p class="banner_text">Book Covid test from the comfort of your home & get 100% accurate reports.</p>
                             <p class="banner_text"> Get your RT PCR test Today with expert and vaccinated technician. 36 Years of Legacy.</p>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="banner_img"><img width="200" height="200"  src=" https://live.staticflickr.com/65535/50107732913_1452bece21_o.png" align="right"></div>
                        </div>
                     </div>
                  </div>
                  </div>
      ...
      <div  id="Protect" class="protect_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
            ...
            <div class="footer_section_2">
               <div class="row">
                  ...
                  <div class="col-lg-3 col-sm-6">
                     ...
                     <p class="footer_text">Main purpose of our website is that user is able to book test for covid-19 online and also track the test.</p>
                  </div>
                  <div class="col-lg-3 col-sm-6">
