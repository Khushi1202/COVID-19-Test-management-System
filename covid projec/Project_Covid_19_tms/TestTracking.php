...
$query="insert into testdata(PatientMobileNumber,TestType,TestTimeSlot,OrderNumber) values('$mnumber','$testtype','$timeslot','$orderno');";
$result = mysqli_query($con, $query);
if ($result) {
echo '<script>alert("Your test request submitted successfully. Order number is "+"'.$orderno.'")</script>';
  echo "<script>window.location.href='TestTracking.php'</script>";
} 
else {
...
<h3 align="center" style="color: black"> Already register "<?php echo $_POST['regmobilenumber'];?>"</h3>
<hr />
    <?php
    $mnumber=intval($_POST['regmobilenumber']);
    $sql=mysqli_query($con,"select * from usertable where MobileNumber='$mnumber'");
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                             ...
                             <div class="form-group">
											  ...
											  <input class="form-control" id="testtype" name="testtype" value="<?php echo $result['RegistrationDate']; ?>" readonly="true">
