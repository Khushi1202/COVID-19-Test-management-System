...
$query="insert into usertable(FullName,MobileNumber,DateOfBirth,FullAddress,State) values('$fname','$mnumber','$dob','$address','$state');";
...
echo '<script>alert("Your test request submitted successfully. Order number is "+"'.$orderno.'")</script>';
  echo "<script>window.location.href='Testbooking.php'</script>";
} 
else {
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                             ...
                             <div class="form-group">
                                            ...
                                            <option value="Antigen">Covid Antigen Test</option>  
                                            <option value="RT-PCR">RT-PCR Test</option>
                                            <option value="CB-NAAT">Antibody Test</option>    
                                              </select>
                                        </div>
